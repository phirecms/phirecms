...
class Between extends Validator
{
    ...
    public function evaluate($input = null)
    {
        ...
        if (null === $this->defaultMessage) {
            if ($this->condition) {
                $this->defaultMessage = I18n::factory()->__('The value must be between %1 and %2.', $nums);
            } else {
                $this->defaultMessage = I18n::factory()->__('The value must not be between %1 and %2.', $nums);
            }
        }

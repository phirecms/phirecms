...
class GreaterThan extends Validator
{
    ...
    public function evaluate($input = null)
    {
        ...
        if (null === $this->defaultMessage) {
            if ($this->condition) {
                $this->defaultMessage = I18n::factory()->__('The value must be greater than %1.', $this->value);
            } else {
                $this->defaultMessage = I18n::factory()->__('The value must not be greater than %1.', $this->value);
            }
        }

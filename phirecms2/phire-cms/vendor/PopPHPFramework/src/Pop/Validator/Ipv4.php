...
class Ipv4 extends Validator
{
    ...
    public function evaluate($input = null)
    {
        ...
        if (null === $this->defaultMessage) {
            if ($this->condition) {
                $this->defaultMessage = I18n::factory()->__('The value must be a valid IPv4 address.');
            } else {
                $this->defaultMessage = I18n::factory()->__('The value must not be a valid IPv4 address.');
            }
        }

...
INSERT INTO "[{prefix}]content" ("id", "type_id", "parent_id", "title", "uri", "slug", "status", "template", "roles", "order", "force_ssl", "hierarchy", "publish", "expire", "created", "updated", "created_by", "updated_by") VALUES (6001, 5001, NULL, 'Home Page', '/', '', 1, '9001', 'a:0:{}', 0, 0, '', datetime('now', 'localtime'), NULL, datetime('now', 'localtime'), NULL, 1001, NULL);
INSERT INTO "[{prefix}]content" ("id", "type_id", "parent_id", "title", "uri", "slug", "status", "template", "roles", "order", "force_ssl", "hierarchy", "publish", "expire", "created", "updated", "created_by", "updated_by") VALUES (6002, 5001, NULL, 'About Us', '/about-us', 'about-us', 1, '9001', 'a:0:{}', 0, 0, '', datetime('now', 'localtime'), NULL, datetime('now', 'localtime'), NULL, 1001, NULL);
